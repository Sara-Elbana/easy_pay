...
class AppColors {
  // Primary Colors
  static const Color primary = Color(0xFF3629B7); // Indigo
  ...
  static const Color debit = Color(0xFFDC2626); // Red for debit
  static const Color credit = Color(0xFF16A34A); // Green for credit
  static const Color pending = Color(0xFFFBBF24); // Amber for pending
