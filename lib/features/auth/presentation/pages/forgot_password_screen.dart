  ...
  Widget _buildStep1(
    ...
    return Column(
      ...
      children: [
        ...
        CustomButton(
          text: "send".tr(),
          backgroundColor: state.phoneNumber.trim().isNotEmpty
              ? AppColors.primary
              : AppColors.gray200,
          foregroundColor: state.phoneNumber.trim().isNotEmpty
              ? Colors.white
              : AppColors.gray400,
    ...
    return Column(
      ...
      children: [
        ...
        CustomButton(
          ...
          backgroundColor: state.verificationCode.trim().isNotEmpty
              ? AppColors.primary
              : AppColors.gray200,
          foregroundColor: state.verificationCode.trim().isNotEmpty
              ? Colors.white
              : AppColors.gray400,
